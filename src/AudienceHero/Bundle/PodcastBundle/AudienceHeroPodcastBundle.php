...
namespace AudienceHero\Bundle\PodcastBundle;

use AudienceHero\Bundle\CoreBundle\Behavior\Module\ModuleProviderInterface;
use Symfony\Component\HttpKernel\Bundle\Bundle;

class AudienceHeroPodcastBundle extends Bundle implements ModuleProviderInterface
{
    /**
    ...
    {
        return '@audiencehero-backoffice/podcast';
    }
    ...
    {
        return '@audiencehero-frontoffice/podcast';
    }
}
