...
use AudienceHero\Bundle\MailingCampaignBundle\Bridge\AudienceHero\ActivityBundle\Aggregator\OpenAggregator;
...
class OpenAggregatorTest extends TestCase
{
    private $computer;
    private $aggregator;
    ...
    public function setUp()
    {
        ...
        $this->aggregator = new OpenAggregator($this->computer->reveal());
    }

    public function testSupportsType()
    {
        $this->assertSame(EmailEvent::EVENT_OPEN, $this->aggregator->supportsType());
    }
