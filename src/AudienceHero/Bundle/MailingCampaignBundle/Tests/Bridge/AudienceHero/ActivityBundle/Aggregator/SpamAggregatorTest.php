...
use AudienceHero\Bundle\MailingCampaignBundle\Bridge\AudienceHero\ActivityBundle\Aggregator\SpamAggregator;
...
class SpamAggregatorTest extends TestCase
{
    private $computer;
    private $aggregator;
    ...
    public function setUp()
    {
        ...
        $this->aggregator = new SpamAggregator($this->computer->reveal());
    }

    public function testSupportsType()
    {
        $this->assertSame(EmailEvent::EVENT_SPAM, $this->aggregator->supportsType());
    }
