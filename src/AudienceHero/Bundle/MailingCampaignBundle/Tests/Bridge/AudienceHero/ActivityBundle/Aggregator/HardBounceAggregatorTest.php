...
use AudienceHero\Bundle\MailingCampaignBundle\Bridge\AudienceHero\ActivityBundle\Aggregator\HardBounceAggregator;
...
class HardBounceAggregatorTest extends TestCase
{
    private $computer;
    private $aggregator;
    ...
    public function setUp()
    {
        ...
        $this->aggregator = new HardBounceAggregator($this->computer->reveal());
    }

    public function testSupportsType()
    {
        $this->assertSame(EmailEvent::EVENT_HARD_BOUNCE, $this->aggregator->supportsType());
    }
