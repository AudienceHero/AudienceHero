...
use AudienceHero\Bundle\MailingCampaignBundle\Bridge\AudienceHero\ActivityBundle\Aggregator\ClickAggregator;
...
class ClickAggregatorTest extends TestCase
{
    private $computer;
    private $aggregator;
    ...
    public function setUp()
    {
        ...
        $this->aggregator = new ClickAggregator($this->computer->reveal());
    }

    public function testSupportsType()
    {
        $this->assertSame(EmailEvent::EVENT_CLICK, $this->aggregator->supportsType());
    }
