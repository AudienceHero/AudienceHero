...
namespace AudienceHero\Bundle\MailingCampaignBundle;

use AudienceHero\Bundle\CoreBundle\Behavior\Module\ModuleProviderInterface;
use Symfony\Component\HttpKernel\Bundle\Bundle;

/**
 * AudienceHeroMailingBundle.
 *
 * @author Marc Weistroff <marc@weistroff.net>
 */
class AudienceHeroMailingCampaignBundle extends Bundle implements ModuleProviderInterface
{
    /**
    ...
    {
        return '@audiencehero-backoffice/mailing-campaign';
    }
