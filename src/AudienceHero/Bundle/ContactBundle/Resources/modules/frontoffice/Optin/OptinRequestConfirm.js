...
export class OptinRequestConfirm extends React.Component {
    componentDidMount() {
        this.updateData();
    }
        ...
        return (
            <Card>
                <CardContent>
                    ...
                    <Typography type="subheading" component="p">
                        {translate(
                            'ah.contact.optin.explain.waiting_optin_confirm'
                        )}
                    </Typography>
                </CardContent>
            </Card>
...
export default enhance(OptinRequestConfirm);
